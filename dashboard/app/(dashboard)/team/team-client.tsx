...
// Roles are POSITIONS, not severities, so all three render neutral and are told apart by their
// label. `admin` previously used the info tone, which reads as "look at this one" on a screen
// where nothing is wrong. Semantic colour on this page is reserved for an expired invitation.
const ROLE_CONFIG = {
  owner: { tone: "neutral" as const, label: "Owner" },
  admin: { tone: "neutral" as const, label: "Admin" },
